...
static const struct gswip_hw_info gswip_xrx500 = {
	.max_ports = GSWIP_XRX500_MAX_PORTS,
	.allowed_cpu_ports = BIT(0),
	/* No port has an xMII mode or delay register: the internal PHY ports
	 * attach over a fixed interface and the external one is not wired.
	 */
...
static const struct gswip_hw_info gswip_xrx500_r = {
...
static const struct of_device_id gswip_xrx500_of_match[] = {
	{ .compatible = "lantiq,xrx500-gswip", .data = &gswip_xrx500 },
	{ .compatible = "lantiq,xrx500-gswip-r", .data = &gswip_xrx500_r },
	{},
};
...
module_platform_driver(gswip_xrx500_driver);
